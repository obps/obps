...
problem~\cite{leung2004handbook} \texbf{PREFER DROZDOWSKI HERE + SURVEY 
...
application errors in order to execute recovery algorithms 
...
\begin{figure*}[h]
  \centering
  \includegraphics[scale=0.6]{CTC-SP2.pdf}
  \includegraphics[scale=0.6]{KTH-SP2.pdf}\\
  \includegraphics[scale=0.6]{CEA-Curi.pdf}
  \includegraphics[scale=0.6]{SDSC-BLU.pdf}\\
  \includegraphics[scale=0.6]{SDSC-SP2.pdf}
  \includegraphics[scale=0.6]{ANL-Intr.pdf}
