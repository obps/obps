...
\todo{introduce the difference in workloads, the duality of avg and max, and the online problem}
...
\begin{figure*}[ht]
  \centering
  \includegraphics[scale=0.6]{ctc_sp.pdf}
  \includegraphics[scale=0.6]{kth_sp.pdf}\\
  \includegraphics[scale=0.6]{sdsc_s.pdf}
  \includegraphics[scale=0.6]{sdsc_b.pdf}\\
  \includegraphics[scale=0.6]{anl_in.pdf}
  \includegraphics[scale=0.6]{unilug.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.6]{cea_cu.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.6]{all.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.6]{mosaic_bandit.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.6]{mosaic_noisy.pdf}
  \caption{Share of the policies chosen by the Noisy policy. The average
  choice is obtained by resampling the original trace 100 times and
  aggregating by date.}
  \label{fig:mosn}
